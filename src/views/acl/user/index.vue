<template>
    ...
    <el-card style="margin: 10px 0px;">
        ...
        <el-table @selection-change="selectChange" style="margin: 10px 0px;" border :data="userArr">
            ...
            <el-table-column label="用户名字" align="center" prop="account" show-overflow-tooltip></el-table-column>
            ...
            <el-table-column label="操作" width="300px" align="center">
                <template #="{ row, $index }">
                    ...
                    <el-popconfirm :title="`你确定要删除${row.account}?`" width="260px" @confirm="deleteUser(row.id)">
                        <template #reference>
        ...
        <template #default>
            <el-form :model="userParams" :rules="rules" ref="formRef">
                <el-form-item label="用户姓名" prop="account">
                    <el-input placeholder="请您输入用户姓名" v-model="userParams.account"></el-input>
                </el-form-item>
        ...
        <template #default>
            <el-form>
                <el-form-item label="用户姓名">
                    <el-input v-model="userParams.account" :disabled="true"></el-input>
                </el-form-item>
